...
public class WorkingHoursServiceImpl implements IWorkingHoursService {
    ...
    public WorkingHours start(WorkingHours workingHours) {
        Optional<WorkingHours> inProgressShift = workingHoursRepository.findOne(WorkingHoursSpecification.matchStartEndAndDriver(workingHours.getStart(), workingHours.getEnd(),workingHours.getDriver().getId()));
